...
@router.get("/permissions/{permission_id}", response_model=PermissionInResponse,)
...
@router.put("/permissions/{permission_id}", response_model=PermissionInResponse,)
async def update_permission(
    ...
    target_permission.desc = info.desc or target_permission.desc
